...
<?php $__env->startPush('js'); ?>
    <script>
        function updateStatus(selectedCheckbox) {
            // Ambil semua checkbox status dengan nama 'condition_status'
            const statusCheckboxes = document.querySelectorAll('input[name="condition_status"]');

            // Hapus centang dari semua checkbox status yang lain
            statusCheckboxes.forEach((checkbox) => {
                if (checkbox !== selectedCheckbox) {
                    checkbox.checked = false; // Hapus centang checkbox lainnya
                }
            });
        }
    </script>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Bian\Documents\Work\Clone\report-hse\resources\views/home.blade.php ENDPATH**/ ?>