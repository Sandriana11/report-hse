                                            ...
                                            <td>
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    ...
                                                    <input type="checkbox" class="form-check-input ms-auto" id="posture"
                                                        ...
                                                        {{ isset($report->ergonomic_health['posture']) ? 'checked' : '' }}
                                                        disabled>
                                                </div>
                                            </td>
                                        </tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    ...
                                                    <input type="checkbox" class="form-check-input ms-auto" id="motionType"
                                                        ...
                                                        {{ isset($report->ergonomic_health['motion_type']) ? 'checked' : '' }}
                                                        disabled>
                                                </div>
                                            </td>
                                        </tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    ...
                                                    <input type="checkbox" class="form-check-input ms-auto"
                                                        ...
                                                        {{ isset($report->working_position['caught_between']) ? 'checked' : '' }}
                                                        disabled>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    ...
                                                    <input type="checkbox" class="form-check-input ms-auto"
                                                        ...
                                                        {{ isset($report->ergonomic_health['load_handled']) ? 'checked' : '' }}
                                                        disabled>
                                                </div>
                                            </td>
                                        </tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    ...
                                                    <input type="checkbox" class="form-check-input ms-auto"
                                                        ...
                                                        {{ isset($report->ppe['arms_hands']) ? 'checked' : '' }} disabled>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    ...
                                                    <input type="checkbox" class="form-check-input ms-auto"
                                                        ...
                                                        {{ isset($report->working_position['falling']) ? 'checked' : '' }}
                                                        disabled>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    ...
                                                    <input type="checkbox" class="form-check-input ms-auto"
                                                        ...
                                                        {{ isset($report->ppe['feet_legs']) ? 'checked' : '' }} disabled>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    ...
                                                    <input type="checkbox" class="form-check-input ms-auto"
                                                        ...
                                                        {{ isset($report->tools_equipment['tools_grip']) ? 'checked' : '' }}
                                                        disabled>
                                                </div>
                                            </td>
                                        </tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    ...
                                                    <input type="checkbox" class="form-check-input ms-auto"
                                                        ...
                                                        {{ isset($report->ppe['respiratory_system']) ? 'checked' : '' }}
                                                        disabled>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    ...
                                                    <input type="checkbox" class="form-check-input ms-auto"
                                                        ...
                                                        {{ isset($report->ergonomic_health['electrical_current']) ? 'checked' : '' }}
                                                        disabled>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    ...
                                                    <input type="checkbox" class="form-check-input ms-auto"
                                                        ...
                                                        {{ isset($report->ergonomic_health['inhaling']) ? 'checked' : '' }}
                                                        disabled>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    ...
                                                    <input type="checkbox" class="form-check-input ms-auto"
                                                        ...
                                                        {{ isset($report->ergonomic_health['vibration']) ? 'checked' : '' }}
                                                        disabled>
                                                </div>
                                            </td>
                                        </tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    ...
                                                    <input type="checkbox" class="form-check-input ms-auto"
                                                        ...
                                                        {{ isset($report->ergonomic_health['absorbing']) ? 'checked' : '' }}
                                                        disabled>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    ...
                                                    <input type="checkbox" class="form-check-input ms-auto"
                                                        ...
                                                        {{ isset($report->environment_housekeeping['lighting']) ? 'checked' : '' }}
                                                        disabled>
                                                </div>
                                            </td>
                                        </tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    ...
                                                    <input type="checkbox" class="form-check-input ms-auto"
                                                        ...
                                                        {{ isset($report->environment_housekeeping['noise']) ? 'checked' : '' }}
                                                        disabled>
                                                </div>
                                            </td>
                                        </tr>
                                            ...
                                            <td class="align-middle">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    ...
                                                    <input type="checkbox" class="form-check-input ms-auto"
                                                        ...
                                                        {{ isset($report->tools_equipment['right_tool']) ? 'checked' : '' }}
                                                        disabled>
                                                </div>
                                            </td>
                                            <td class="align-middle">
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    ...
                                                    <input type="checkbox" class="form-check-input ms-auto"
                                                        ...
                                                        {{ isset($report->tools_equipment['used_correctly']) ? 'checked' : '' }}
                                                        disabled>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    ...
                                                    <input type="checkbox" class="form-check-input ms-auto"
                                                        ...
                                                        {{ isset($report->tools_equipment['tools_condition']) ? 'checked' : '' }}
                                                        disabled>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    ...
                                                    <input type="checkbox" class="form-check-input ms-auto"
                                                        ...
                                                        {{ isset($report->tools_equipment['others']) ? 'checked' : '' }}
                                                        disabled>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    ...
                                                    <input type="checkbox" class="form-check-input ms-auto"
                                                        ...
                                                        {{ isset($report->tools_equipment['others2']) ? 'checked' : '' }}
                                                        disabled>
                                                </div>
                                            </td>
                                            <td></td>
                                            <td>
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    ...
                                                    <input type="checkbox" class="form-check-input ms-auto"
                                                        ...
                                                        {{ isset($report->environment_housekeeping['others3']) ? 'checked' : '' }}
                                                        disabled>
                                                </div>
                                            </td>
                                        </tr>
